        ...
        <section className="mt-12 p-10 flex flex-col md:flex-row items-center gap-8 bg-gray-800">
            ...
            <div>
                ...
                <p className="text-gray-200 mb-4 max-w 4xl">
                    Hello, I'm Bratty Brat -  a self-taught developer and educator, passionate about building fridendly digital experiences and helping others grow into confident modern developers.
                </p>
