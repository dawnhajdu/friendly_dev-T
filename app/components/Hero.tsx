...
const Hero: React.FC<HeroProps> = ({name='[NAME]', text='I build fridently web experiences and help others become confident modern developers.'}) => {
    return ( 
        <header className="text-center py-20 px-4 bg-gray-900 text-white transition-colors duration-300">
            ...
            <div className="flex justify-center gap-4">
                <Link to='/projects' className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700">View Projects</Link>
